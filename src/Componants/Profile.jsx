      ...
      >
        ...
        <div className="bg-[#1a1a2e]/80 backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] rounded-full px-4 py-3 md:px-6 md:py-3 flex items-center justify-between transition-all duration-300 hover:border-white/20 relative z-50">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="#contact"
              className="px-5 py-2 md:px-6 md:py-2.5 bg-gradient-to-r from-[#00d2ff] via-[#3a7bd5] to-[#00d2ff] bg-[length:200%_auto] text-white font-bold text-xs md:text-sm rounded-full shadow-[0_0_20px_rgba(0,210,255,0.3)] hover:shadow-[0_0_25px_rgba(0,210,255,0.5)] transition-all duration-300 animate-gradient hover:scale-105"
            >
              Let's Talk
            </a> 
