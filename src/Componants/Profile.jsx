  ...
  return (
    <> 
      ...
      >
        ...
        <div
          className={`md:hidden fixed inset-0  h-155 bg-[#020617]/95 backdrop-blur-2xl transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] z-40 flex flex-col justify-center
